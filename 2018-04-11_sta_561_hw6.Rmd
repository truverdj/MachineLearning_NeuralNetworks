...
For simplicity, let 
$$
\frac{\text{binom}(x_i;n, \theta_k^{(t)})(0.50)}{\text{binom}(x_i;n, \theta_1^{(t)})(0.50) + \text{binom}(x_i;n, \theta_2^{(t)})(0.50)} 
= \gamma_{ik}
$$
then 
$$
A(\theta, \theta^{(t)}) = \sum_i\sum_k \gamma_{ik} \log\frac{P(X_i = x_i, Z_i = k\mid\theta)}{\gamma_{ik}}.
$$
